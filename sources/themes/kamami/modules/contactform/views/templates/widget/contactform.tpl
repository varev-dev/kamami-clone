      ...
      <section class="form-fields">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6">
            <select name="id_contact" id="id_contact" class="form-control form-control-select">
              <option disabled="" selected="" value="">{l s='Select subject' d='Shop.Forms.Help'}</option>
        ...
        {if $contact.allow_file_upload}
          <div class="form-group row">
            ...
            <div class="col-md-6">
              <input id="file-upload" type="file" name="fileUpload" class="filestyle" data-buttontext="{l s='Choose file' d='Shop.Theme.Actions'}" tabindex="-1">
            </div>
