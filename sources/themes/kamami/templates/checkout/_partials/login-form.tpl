              ...
              <div class="input-group js-parent-focus">
                ...
                <span class="input-group-btn show-password">
                  <button class="btn" type="button" data-action="show-password"
                    data-text-show="{l s='Pokaż' d='Shop.Theme.Actions'}" data-text-hide="{l s='Ukryj' d='Shop.Theme.Actions'}">
...
{block name='login_form_footer'}
  <footer class="form-footer text-sm-center clearfix">
    ...
    {block name='form_buttons'}
      <button class="continue btn btn-primary" name="continue" data-link-action="sign-in" type="submit" value="1">
